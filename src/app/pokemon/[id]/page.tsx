...
export default async function PokemonPage({ params }: Props) {
  ...
  return (
    <div className="min-h-screen p-8 pb-20 flex flex-col items-center relative">
      ...
      <ViewTransition name={`card-${pokemon.id}`}>
        <main className="flex flex-col gap-x-1 items-center w-full max-w-2xl p-2 md:px-8">
          <h1 className="text-5xl text-zinc-800 dark:text-zinc-200 font-extrabold capitalize">
            {pokemon.name}
          </h1>
          <Image
          ...
          <div className="border-zinc-200 border-1 rounded-md p-2 w-full max-w-lg mb-5">
            <ul className="text-xl text-zinc-700 dark:text-zinc-300 mb-2 list-none">
              <li className="mb-2 flex items-center">
                ...
                <span className="font-semibold mx-3">Height:</span>
